...
jQuery(function() {
	...
	var img = '';
	var real_path = '{{ url("/") }}' + response.data.path;
        img += '<div style="'+'width:260px; height:260px; background:url(' + real_path + ') no-repeat center / cover" class="thumbnail">';
        img += '</div>';
        $(".pic").html(img);
        //$("#select-bar").remove();
